...
clustering_new_pre_PCA3.1_copy %>%
  ...
  group_by(ssid)%>%
  transform(pup_basCor = sample(pup_basCor, replace = F),
            Bio_Mean_HR_dif = sample(Bio_Mean_HR_dif, replace = F),
            log_BIO_CDA.PhasicMax = sample(log_BIO_CDA.PhasicMax, replace = F),
