...
tmp.df4_full_stim_downs_jun2021_60bins <- tmp.df4_full_stim_downs_jun2021_60bins%>%
  ...
  mutate(neutral_neg_mean_arousal = mean(ArousalMean, na.rm = TRUE),
                                         neutral_sd_mean_arousal = sd(ArousalMean, na.rm = TRUE)) %>%
...
# compute new varoables where arousal is scaled to negative (negative value - mean of negative and neutral) same to positive
tmp.df4_full_stim_downs_jun2021_60bins <- tmp.df4_full_stim_downs_jun2021_60bins %>%
