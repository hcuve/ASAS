...
clust_dataset = clustering_agg[c(25,24,20)]
...
pca_res <- prcomp(clustering_agg_bonkers[1:55,c(25,24,20)], center = TRUE, scale. = TRUE)
pca_res <- prcomp(clustering_agg_JASPtest[,c(24,23,19)], center = TRUE, scale. = FALSE)
