...
p$graphstyle_int <-  theme(#base plot theme
  ...
  axis.text.y = element_text(size = 14*(sf+.1), colour = "black"),#√
...
res.MFA_stim_val_scal2e_sidnorm <-MFA(newDFscale_sid_norm[,1:7],group=c(2,3,2), type=c("n","c","c"),name.group=c("qualitative","autonomic","subjective"),
                                      num.group.sup=c(1),graph=TRUE)

# stim plot

res.MFA_stim_val_scal2e_stim <-MFA(newDFscale_stim[,1:7],group=c(2,3,2), type=c("n","c","c"),name.group=c("qualitative","autonomic","subjective"),
                                      num.group.sup=c(1),graph=TRUE)
