...
db_IQ1<- select(db_IQ, c(1,13,16, 37,40:44))
...
db_self_rep_345_356<- db_self_rep_345_356[,c(1:22)]

write_csv(db_self_rep, "db_self_rep_345_356_final.csv")
```